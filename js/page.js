define("project/zt/2019/0424kyldy/js/page",
    ...
    function (require) {
      ...
      require("./common/dialog/css/ui-dialog.css"),
          require("./common/try-listen.css"), require("./common/tab-switch");
      var b = require("./js/con-slide"),
          ...
          i = {
            ...
            initLongtermLearnPlan: function () {
              ...
              var b = -1;
              this.$longtermLearnPlan.on("mouseenter", ".jp-circle",
                  function (c) {
                  ...
                  _.each(this.$longtermLearnPlan.find(".jp-content"),
                      function (a) {
        ...
        function (require) {
          var a = $(window),
              ...
              d = {
                ...
                unbind: function () {
                  a.off("resize.delayload"),
                      a.off("scroll.delayload"),
                      b.off("scroll.delayload")
                },
                _fnCheck: function () {
...
"undefined" != typeof define && define("project/zt/2019/0424kyldy/js/common/tab-switch", [],
    function () {
    }),
    function (a) {
      var b = function () {
      ...
      a.tabSwitch = function (b) {
        var d = a.extend(!0, {}, c, b),
            ...
            h = function () {
              var b = a(this),
                  c = f.index(b),
                  h = e.find("." + d.currClassName).index();
              return c === h ? void(d.toggle && (b.removeClass(d.currClassName),
                  g.hide(),
                  d.afterSwitch(h, c, g.eq(c)))) : void(d.beforeSwitch(h, c, g.eq(c)) !== !1 && (f.removeClass(d.currClassName),
                  b.addClass(d.currClassName),
                  g.removeClass(d.currContentCls).hide().eq(c).fadeIn("slow").addClass(d.currContentCls),
                  d.afterSwitch(h, c, g.eq(c))))
            };
    ...
    define("project/zt/2019/0424kyldy/js/js/con-slide", [],
        function () {
          var a = {
            init: function (a) {
              function b() {
                var a = e.position().left;
                i > 0 ? a > -j / 2 ? e.animate({left: a - h}) : (e.css("left", 0),
                    e.animate({left: -h})) : 0 > a ? e.animate({left: a + h}) : (e.css("left", -j / 2),
                    e.animate({left: -j / 2 + h}))
              }
              ...
              var d = null,
                  e = a.find(".jp-slide-wrap .jp-list").eq(0),
                  f = a.find(".jp-prev"),
                  g = a.find(".jp-next"),
                  h = e.find("li").eq(0).outerWidth(),
                  i = 1;
              e.append(e.html());
    ...
    define("project/zt/2019/0424kyldy/js/js/evaluation", [],
        function () {
          var a = {
            init: function (a) {
              function b(a, b, c) {
              ...
              function d() {
                var a = f.eq(j).find(".ev-img"),
                    d = a.length,
                    e = f.eq(k).find(".ev-img"),
                    h = e.length, i = 0;
                g.removeClass("on"),
                    g.eq(j).addClass("on"),
                    k == j ? b(i, a, d) : c(i, e, h,
              ...
              e(),
                  g.on({
                    mouseover: function (a) {
                      var b = $(a.currentTarget);
                      return b.hasClass("on") ? !1 : (g.removeClass("hover"),
                          void b.addClass("hover"))
                    }, mouseout: function (a) {
                      var b = $(a.currentTarget);
                      b.removeClass("hover")
                    }
                ...
                clearInterval(l),
                    clearInterval(m),
                    clearInterval(n),
                    h.stop(!0, !0).css("left", "1500px"),
                    j = $(a.currentTarget).index(),
                    k = j, d()
              }), h.on({
                mouseover: function (a) {
        ...
        function () {
          var a = {
            init: function (b, c, d, e, f, g) {
              ...
              function j(a) {
                var b = r.eq(o).find("img"),
                    c = s.eq(o).find(".tip"),
                    d = c.length;
                d - 1 > a ? (b.eq(a).animate({opacity: 1}, 1e3),
                    m.collision(c.eq(a),
                        f,
                        e[o][a], 8, .3,
                        function () {
              ...
              function k() {
                q.hide().animate(t,
                    ...
                    r.find("img").animate(t),
                    p.animate(t, 1e3),
                    s.find(".tip").css({opacity: 0, top: f + "px"})
              }
              ...
              var m = a,
                  ...
                  s = b.find(".tips"),
                  t = {opacity: 0},
                  u = {top: "0", left: "0", width: "100%", height: "100%", opacity: "1"},
                  v = null;
              l(),
            ...
            collision: function (a, b, c, d, e, f) {
              function g(a) {
                ...
                i = setInterval(function () {
                  ...
                  Math.abs(h) < 1 && (h = 0),
                      0 == h && d == c ? (a.css("top", c),
                          clearInterval(i), f && setTimeout(function () {
                        f()
        ...
        function (require) {
          ...
          var a = require("common/kooplayer/4.x/kooplayer"),
              ...
              c = '<div class="i-dialog-listen i-dialog-wrap hidden">' +
                  ...
                  '</span></div><div class="i-dialog-content"><div class="i-tabs cb">' +
                  '<table><tr></tr></table></div><div class="i-contents"></div></div></div>',
              d = {},
              e = {
                vedioOpts: d,
                popData: {
          ...
          return g.extend({
            __init: function () {
              0 == $("body").find(".i-dialog-listen").length && $("body").append(c),
                  this.$listen = $(".i-dialog-listen"),
                  this.itabs = this.$listen.find(".i-tabs"),
                  this.itabsTr = this.itabs.find("tr"),
                  this.$content = this.$listen.find(".i-contents"),
                  this.dialogHeadTitle = this.$listen.find(".i-dialog-t h1"),
                  this.dialogMoreListenBtn = this.$listen.find(".jp-more-listen"),
                  this.dialogBuyBtn = this.$listen.find(".jp-buy-listen"),
              ...
              if (a.length > this.loadIndex) {
                ...
                c.type = "text/javascript",
                    c.src = a[this.loadIndex],
                    this.head.appendChild(c),
                    c.readyState ? c.onreadystatechange = function () {
                      ("loaded" == c.readyState || "complete" == c.readyState) && (c.onreadystatechange = null, b.loadIndex = b.loadIndex + 1,
                          b.__loadScript(a))
                    } : c.onload = function () {
            ...
            showListenPop: function (b, c) {
              ...
              if (this.itabsTr.empty(),
                      this.$content.empty(),
                      "" == this.popData.title.length ? this.$listen.find(".i-dialog-t").hide() : (this.$listen.find(".i-dialog-t").show(),
                          this.dialogHeadTitle.html(this.popData.title),
                          this.dialogMoreListenBtn.attr("href", this.popData.moreListenUrl),
                          this.dialogBuyBtn.attr("href", this.popData.buyUrl)), g)
                for (; g--;) this.itabsTr.prepend(0 == g ? "<td class='hover'>" + f[g].title + "</td>" : "<td>" + f[g].title + "</td>");
              if (c.hasClass("p-free-listen"))
                var h = {
                  content: this.$listen,
                  width: 1e3,
                  fixed: !0,
              ...
              this.popData.videoTitleShow ? ($(".i-close").css("top", "-22px"),
                  this.itabs.show()) : (this.itabs.hide(), $(".i-close").css("top", "-52px"));
                ...
                $.ajax({
                  ...
                  success: function (b) {
                    ...
                    d.player && (d.player = null),
                        d.$content.find("#listen-player").remove().end().append($("<div>", {
                          id: "listen-player",
                          height: 400
                        })), setTimeout(function () {
              ...
              }).filter(".hover").trigger("click"),
                  this.__closeDialog(dialog(h).showModal())
            },
            showMp4ListenPop: function (a) {
              ...
              if (this.$listen.find(".i-dialog-t h1").html(a.nameTitle).end().find(".i-tabs").hide().end().find(".i-contents").empty().append(b).css({height: 400}),
                      this.$listen.find(".i-dialog-t").hide(),
                      $(".i-close").css("top", "-32px"),
                ...
                b.css("height", .62 * c + "px"),
                    audio_public_creat.charactor.plug(b, {autoplay: "autoplay"})
              }
            }
          }), new f
        }),
    define("project/zt/2016/0114kyldy/js/common/dialog/css/ui-dialog.css", [],
        function () {
          seajs.importStyle(".ui-dialog-content,.ui-dialog-loading," +
    ...
    define("project/zt/2016/0114kyldy/js/common/dialog/js/dialog-plus", ["./dialog", "./popup", "./dialog-config"],
        function (require) {
          ...
          return a.oncreate = function (a) {
            var b,
                ...
                e = c.url,
                f = c.oniframeload;
            if (e && (this.padding = c.padding = 0, b = $("<iframe />"),
                    b.attr({
                      src: e,
                      name: a.id,
                      width: "100%",
                    ...
                    a.content(b[0]), a.iframeNode = b[0]),
                    !(d instanceof Object)) for (var g = function () {
              a.close().remove()
            }, h = 0; h < frames.length; h++)
              try {
              ...
              a.get = function (b) {
                if (b && b.frameElement) {
                  ...
                  for (var f in e) if (c = e[f],
                      c.node.getElementsByTagName("iframe")[0] === d) return c
                } else if (b) return a.list[b]
              }, a
        }),
    define("project/zt/2016/0114kyldy/js/common/dialog/js/dialog", ["./popup", "./dialog-config"],
        function (require) {
          ...
          if (c) {
            ...
            d && (c = d(c),
                ...
                $("base")[0] ? $("base").before(c) : $("head").append(c))
          }
              ...
              i = !g && !h, j = function (a, b, c) {
                ...
                ("string" == typeof a || 1 === a.nodeType) && (a = {
                  ...
                  fixed: !h
                    ...
                    a = $.extend(!0, {},
                        j.defaults, a), a.original = d;
                var g = a.id = a.id || f + e, k = j.get(g);
                return k ? k.focus() : (i || (a.fixed = !1),
                a.quickClose && (a.modal = !0, a.backdropOpacity = 0),
                $.isArray(a.button) || (a.button = []),
                void 0 !== c && (a.cancel = c),
          ...
          return j.create = function (b) {
            ...
            b.zIndex && (a.zIndex = b.zIndex),
                ...
                this._$("close").css("display",
                    this.cancel === !1 ? "none" : "").attr("title",
                    this.cancelValue).on("click", function (a) {
            ...
            content: function (a) {
              ...
              return "object" == typeof a ? (a = $(a), b.empty("").append(a.show()),
              ...
              return this.callbacks = {},
                  "string" == typeof a ? (c = a, d++) : $.each(a, function (a, e) {
                    var f = e.id = e.id || e.value, g = "";
                    b.callbacks[f] = e.callback,
                        e.display === !1 ? g = ' style="display:none"' : d++,
                        c += '<button type="button" i-id="' + f + '"' + g + (e.disabled ? " disabled" : "") + (e.autofocus ? ' class="ui-dialog-autofocus"' : "") + ">" + e.value + "</button>", b._$("button").on("click", "[i-id=" + f + "]", function (a) {
                      var c = $(this);
        ...
        }), define("project/zt/2016/0114kyldy/js/common/dialog/js/popup", [],
    function () {
      function a() {
        this.destroyed = !1,
            ...
            this.backdrop = this.__backdrop[0], b++
      }
      ...
      return $.extend(a.prototype, {
        ...
        show: function (b) {
          ...
          if (this.__activeElement = this.__getActive(), this.open = !0, this.follow = b || this.follow, !this.__ready) {
            if (e.addClass(this.className).attr("role", this.modal ? "alertdialog" : "dialog").css("position",
                    this.fixed ? "fixed" : "absolute"),
                c || $(window).on("resize", $.proxy(this.reset, this)),
                    this.modal) {
              var g = {
                position: "fixed",
                left: 0,
              ...
              e.addClass(this.className + "-modal"), d || $.extend(g, {
                ...
                height: $(document).height() + "px"
                  ...
                  f.css(g).attr({tabindex: "0"}).on("focus", $.proxy(this.focus, this)),
                  this.__mask = f.clone(!0).attr("style", "").insertAfter(e),
                  f.addClass(this.className + "-backdrop").insertBefore(e),
                  this.__ready = !0
            }
        ...
        remove: function () {
          ...
          a.current === this && (a.current = null),
              ...
              this.__mask.remove(),
          c || $(window).off("resize", this.reset),
        ...
        __center: function () {
          ...
          m.left = Math.max(parseInt(k), e) + "px",
              m.top = Math.max(parseInt(l), f) + "px"
        },
        __follow: function (a) {
          ...
          var e = this,
              ...
              F = {left: t + o / 2 - m / 2, top: u + p / 2 - n / 2},
              G = {left: [v, x], top: [w, y]};
          $.each(A, function (a, b) {
            E[a][b] > G[D[b]][1] && (b = A[a] = C[b]), E[a][b] < G[D[b]][0] && (A[a] = C[b])
          }),
          A[1] || (D[A[1]] = "left" === D[A[0]] ? "top" : "left", E[1][A[1]] = F[D[A[1]]]),
              B += A.join("-") + " " + this.className + "-follow",
              e.__followSkin = B,
          b && c.addClass(B),
              z[D[A[0]]] = parseInt(E[0][A[0]]),
              z[D[A[1]]] = parseInt(E[1][A[1]]),
              c.css(z)
        },
        __offset: function (a) {
    ...
    define("common/kooplayer/4.x/js/kooplayer-adapter", ["./client-test", "./flash-player", "./web-h5-player"], function (require, exports, module) {
      function a() {
        var a = window.MediaSource || window.WebKitMediaSource,
            b = window.SourceBuffer || window.WebKitSourceBuffer,
      ...
      function b(a, b) {
        ...
        if (d.isPc) {
          if ($("#" + a).css("overflow", "hidden"), l.useH5)
            if (s && m)
              var n = f.init(a, l);
            else var n = e.init(a, l, s);
          else var n = e.init(a, l, !1);
          return i = new c("pcPlayer" + l.layId, g, n)
        }
        if (!videojs || !videojs.videoXdf)
          return console.warn("videojs is undefined,player not init"), i;
        var p = "videoid" + +new Date + o(),
            q = k.replace("{id}", p);
        $("#" + a).append($(q));
      ...
      $.each({
          ...
          function (a, b) {
            ...
            return e ? void(c.prototype[b] = function () {
              if ($.isFunction(e))
                return e.apply(this.playerObj, n(arguments));
    ...
    define("common/kooplayer/4.x/js/client-test", [],
    ...
    define("common/kooplayer/4.x/js/flash-player", [], function () {
      function a(a) {
        if (window.sessionStorage) {
          ...
          }, 1e3), localStorage.setItem("kooplayerWebUsed", "1"),
      ...
      var b = {
          ...
          f = function () {
            ...
            return function (b) {
              ...
              return function () {
                var a, b, c;
                f.ownStatistics && (a = $.cookie ? $.cookie("KUID") : null,
                a && (f.ownStatistics.KUID = a),
                    b = navigator.userAgent.toLowerCase(),
                    c = b.match(/(?:koolearn;\s)((?:[^\s]+\s)(?:.{1,2}\/\d+\/\d+))/i), c && (f.ownStatistics.appVersion = c[1]))
